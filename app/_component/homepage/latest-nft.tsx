...
export default async function LatestNft() {
    ...
    return (
        ...
        >
            <div className="flex items-end self-stretch py-[360px] pb-[60px]">
                <div className="lg:max-w-[1050px] md:max-w-[690px] max-w-[315px] mx-auto flex flex-col items-start gap-8 w-full">
                    ...
                    <div className=" w-full gap-[30px] grid md:grid-cols-2">
                        <h2 className="text-[51px] font-semibold capitalize leading-[110%] text-white">
                            Magic Mashrooms
                        </h2>
