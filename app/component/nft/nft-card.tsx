...
export default function NFT_Card({nft,}:{nft: NFT}) {
    ...
    return (
        <Link href='#' className="flex w-[330px] flex-col trans">
            <Image width={296} height={238} className="md:h-[296px] h-[238px] rounded-t-[20px] w-full object-cover" src={nft.image}
                alt="image-main" />
            <div className="flex-1 flex p-[20px_30px_25px_30px] flex-col gap-[25px] bg-background rounded-b-[20px]">
                ...
                <div className="flex justify-between">
                    ...
                    <div className="flex flex-col gap-2 font-space-mono">
                        ...
                        <span className="ntf-card__info-item-value">
                            {nft.highest_bid}
                        </span>
                    </div>
                </div>
